...
module.exports = {
  ...
  OrderStateMachine: require("./OrderStateMachine"),
  OrderInventoryService: require("./OrderInventoryService"),
  OrderIdempotencyService: require("./OrderIdempotencyService"),
  OrderSecurity: require("./OrderSecurity"),
  createOrderPlatform,
  getOrderPlatform,
